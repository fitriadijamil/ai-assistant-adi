...
Tugas Anda adalah menulis 1 paragraf pendek pengantar teknis untuk surat penawaran harga.

YANG HARUS ANDA TULIS:
- 1 paragraf pendek (1-2 kalimat) yang menjelaskan sistem yang ditawarkan berdasarkan jumlah kamera, resolusi, storage, dan bandwidth
